...
function DisplaySettingsMenu({ onColorTheme, onTyping }) {
    return (
        <div id='settings-menu-container'>
            <img className='settings-menu-item' id='settings-color-theme-icon' onClick={onColorTheme} src='/images/color_theme.png' />
            <img className='settings-menu-item' id='settings-user-typing-icon' onClick={onTyping} src='/images/typing_notification.png' />
        </div>
    );
}
...
function DisplayTypingNotification(props) {
    return (
        <div className='settings-submenu typing-notification-submenu'>
            <img className='settings-submenu-img' id='typing-notification-img' src='/images/chat_bubble.gif' />
