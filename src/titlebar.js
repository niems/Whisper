...
const Titlebar = ({ isElectron, onToggleSettings, onClose })  => {

    if ( isElectron ) { //runs if the client view is an electron window
        return (
            <div id='display-titlebar-container'>
                <img id='titlebar-menu-icon' onClick={onToggleSettings} src='/images/titlebar_icons/menu-white.svg' alt='failed to load menu icon' />
